...
asm_naked_fn(scrypt_ChunkMix_avx)
	...
	a1(scrypt_ChunkMix_avx_loop:)
		...
		a1(scrypt_salsa_avx_loop: )
			...
			a3(vpsrld $25, %xmm5, %xmm4)
			a3(vpslld $7, %xmm4, %xmm4)
			a3(vpxor %xmm5, %xmm3, %xmm3)
			a3(vpxor %xmm4, %xmm3, %xmm3)
			a3(vpaddd %xmm3, %xmm4, %xmm0)
			a3(vpsrld $23, %xmm5, %xmm4)
			a3(vpslld $9, %xmm4, %xmm4)
			a3(vpxor %xmm5, %xmm2, %xmm2)
			a3(vpxor %xmm4, %xmm2, %xmm2)
			a3(vpaddd %xmm2, %xmm4, %xmm3)
			a3(vpsrld $19, %xmm5, %xmm4)
			a3(vpslld $13, %xmm4, %xmm4)
			a3(vpxor %xmm5, %xmm1, %xmm1)
			a3(vpshufd $0x93, %xmm3, %xmm3)
			a3(vpxor %xmm4, %xmm1, %xmm1)
			a3(vpaddd %xmm1, %xmm4, %xmm2)
			a3(vpsrld $14, %xmm5, %xmm4)
			a3(vpslld $18, %xmm4, %xmm4)
			a3(vpxor %xmm5, %xmm0, %xmm0)
			a3(vpshufd $0x4e, %xmm2, %xmm2)
			a3(vpxor %xmm4, %xmm0, %xmm0)
			a3(vpaddd %xmm0, %xmm4, %xmm3)
			a3(vpshufd $0x39, %xmm1, %xmm1)
			a3(vpsrld $25, %xmm5, %xmm4)
			a3(vpslld $7, %xmm4, %xmm4)
			a3(vpxor %xmm5, %xmm1, %xmm1)
			a3(vpxor %xmm4, %xmm1, %xmm1)
